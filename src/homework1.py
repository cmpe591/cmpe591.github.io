...
class Homework1(environment.BaseEnv):
    def __init__(self, n_actions=8) -> None:
        super().__init__()
    ...
    def step(self, action_id, render=None):
        ...
        if render is None:
            ...
            self._set_ee_in_cartesian(target_pos, rotation=[-90, 0, 180], n_splits=30, render=True, threshold=0.04)
        self._t += 1
